...
object RavenGoblinSystemsRegistryOS {
    ...
    val organs = listOf(
        ...
        Organ("MODULE_RACK", Stage.GOVERN, Cost.CORE, "MODULE_PLAN", listOf("RV_RESILIENCE")),
        Organ("LATE_EXTENSION_RACK", Stage.GOVERN, Cost.CORE, "MODULE_EXECUTION", listOf("MODULE_RACK")),
        Organ("GOBLIN_ENGINE", Stage.GOVERN, Cost.CORE, "TRANSACTION", listOf("PRESENTATION_ARBITER", "LATE_EXTENSION_RACK")),
    ...
    val baseBrainMandatory = setOf(
        ...
        "MODULE_RACK", "LATE_EXTENSION_RACK", "GOBLIN_ENGINE",
        "SURFACE_ROUTER", "REACTION_STATE", "OFFICE_STATE", "OFFICE_BAR",
    )

...
object RavenGoblinSystemsRegistryOS {
    ...
    val organs = listOf(
        ...
        Organ("DIALOGUE_DIRECTOR", Stage.WRITERS, Cost.LIGHT, "PRESENTATION", listOf("SCENE_GRAPH", "PHONE_SCENE", "TRICK_HISTORY")),
        Organ("META_GRAMMAR", Stage.WRITERS, Cost.LIGHT, "FICTION_ONLY", listOf("TRICK_HISTORY", "ANTI_REPEAT")),
        Organ("CONVERSATION_DIRECTOR", Stage.WRITERS, Cost.LIGHT, "PRESENTATION", listOf("DIALOGUE_DIRECTOR", "META_GRAMMAR", "TRICK_HISTORY")),
